...
class CarState(CarStateBase):
  ...
  def update_pq(self, pt_cp, cam_cp, ext_cp, trans_type):
    ...
    ret.steerFaultPermanent = hca_status in ("DISABLED", "FAULT") and ret.cruiseState.speed != 0
    ret.steerFaultTemporary = hca_status in ("INITIALIZING", "REJECTED") and ret.cruiseState.speed != 0
